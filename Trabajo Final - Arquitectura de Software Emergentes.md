...
| HU-025            | Desplazarse entre las secciones de landing page\|                 | Como usuario quiero desplazarme entre las secciones de landing page para visualizar las funcionalidades                                                                                     |              3               |
| HU-026            | Visualizar los beneficios de los planes                           | Como usuario quiero visualizar los beneficios de los planes que brinda la plataforma para cada segmento                                                                                     |              2               |
| HU-027            | Visualizar información sobre los desarrolladores de la app        | Como usuario quiero obtener información sobre los desarrolladores de la aplicación para sentirme más seguro                                                                                 |              2               |
| HU-028            | Visualizar sección de landing page para los segmentos de usuarios | Como usuario quiero ver una sección de la landing page con información relacionada al segmento que corresponde para ver sus beneficios                                                      |              2               |
