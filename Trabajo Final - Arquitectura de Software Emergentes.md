...
| HU-026            | Visualizar los beneficios que ofrece la aplicación                | Como usuario quiero visualizar los beneficios que brinda la plataforma para cada segmento                                                                                                   |              2               |
...
| HU-028            | Visualizar sección de landing page para los segmentos de usuarios | Como usuario quiero ver una sección de la landing page con información relacionada al segmento que corresponde                                                                              |              2               |
